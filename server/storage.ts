...
export class DatabaseStorage implements IStorage {
  ...
  private seedLectures(): void {
    const prabhupadaLectures = [
      {
        id: 1,
        title: "The Acharya - Complete Documentary",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
        topic: "Biography",
        duration: 1860,
        videoUrl: "https://www.youtube.com/watch?v=a6PaVkPhPiU",
        description: "Complete documentary about Srila Prabhupada's life and mission as the Acharya of Krishna consciousness.",
        createdAt: new Date()
      },
      {
        id: 2,
        ...
        description: "Documentary showcasing Prabhupada's compassionate nature and his dedication to spreading Krishna consciousness worldwide.",
        createdAt: new Date()
      },
      {
        id: 3,
        ...
        description: "Prabhupada explains the scientific approach to understanding God and spiritual realization.",
        createdAt: new Date()
      },
      {
        id: 4,
        ...
        description: "Documentary about the early Krishna consciousness movement and its philosophy.",
        createdAt: new Date()
      },
      {
        id: 5,
        ...
        description: "Learn the proper method of chanting japa meditation with Srila Prabhupada's guidance.",
        createdAt: new Date()
      },
      {
        id: 6,
        ...
        description: "Prabhupada explains the invaluable gifts of Krishna consciousness and devotional service.",
        createdAt: new Date()
      },
      {
        id: 7,
        title: "Happiness on 2nd Avenue",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
        topic: "History",
        duration: 502,
        videoUrl: "https://www.youtube.com/watch?v=KSrABGtI-58",
        description: "Historical footage from Prabhupada's early days in New York City spreading Krishna consciousness.",
        createdAt: new Date()
      },
      {
        id: 8,
        title: "Hare Krishna Documentary",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
        topic: "Philosophy",
        duration: 976,
        videoUrl: "https://www.youtube.com/watch?v=gkcMTc2ROuE",
        description: "Classic documentary explaining the essence of Hare Krishna philosophy and practice.",
        createdAt: new Date()
      },
      {
        id: 9,
        title: "Vaisnavas - The Devotees",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
        topic: "Devotional Service",
        duration: 659,
        videoUrl: "https://www.youtube.com/watch?v=0nhqC3fBF3c",
        description: "Understanding the nature and qualities of Vaisnavas (devotees of Krishna).",
        createdAt: new Date()
      },
      {
        id: 10,
        title: "Swamiji - Early Days in America",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
        topic: "History",
        duration: 523,
        videoUrl: "https://www.youtube.com/watch?v=ewbEdxczUaE",
        description: "Intimate footage of Prabhupada's early mission in America and his interactions with first disciples.",
        createdAt: new Date()
      }
    ];
