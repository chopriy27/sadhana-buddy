...
export class DatabaseStorage implements IStorage {
  ...
  private seedLectures(): void {
    const prabhupadaLectures = [
      {
        id: 1,
        title: "Bhagavad-gita 2.13 - The Soul is Eternal",
      ...
      {
        id: 2,
        title: "Bhagavad-gita 4.9 - Krishna's Divine Appearance", 
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
        topic: "Bhagavad Gita",
        duration: 2880,
        videoUrl: "https://www.youtube.com/@TheAcharya1",
      ...
      {
        id: 3,
        title: "Bhagavad-gita 7.1 - Knowing Krishna in Truth",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
        topic: "Bhagavad Gita",
        duration: 3120,
        videoUrl: "https://www.youtube.com/@TheAcharya1",
      ...
      {
        id: 4,
        title: "Srimad-Bhagavatam 1.2.6 - Devotional Service",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
      ...
      {
        id: 5,
        title: "Bhagavad-gita 9.2 - The King of Knowledge",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
        topic: "Bhagavad Gita",
        duration: 3300,
        videoUrl: "https://www.youtube.com/@TheAcharya1",
      ...
      {
        id: 6,
        title: "Bhagavad-gita 18.66 - Surrender to Krishna",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
        topic: "Bhagavad Gita",
        duration: 2640,
        videoUrl: "https://www.youtube.com/@TheAcharya1",
      ...
      {
        id: 7,
        title: "Srimad-Bhagavatam 2.1.1 - Remembering Krishna",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
        topic: "Srimad Bhagavatam",
        duration: 2520,
        videoUrl: "https://www.youtube.com/@TheAcharya1",
      ...
      {
        id: 8,
        title: "Bhagavad-gita 15.7 - The Living Entity",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
        topic: "Bhagavad Gita",
        duration: 2400,
        videoUrl: "https://www.youtube.com/@TheAcharya1",
      ...
      {
        id: 9,
        title: "Nectar of Devotion - Pure Bhakti",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
      ...
      {
        id: 10,
        title: "Bhagavad-gita 10.8 - I am the Source",
        speaker: "A.C. Bhaktivedanta Swami Prabhupada",
        topic: "Bhagavad Gita",
        duration: 1800,
        videoUrl: "https://www.youtube.com/@TheAcharya1",
